...
const About = () => {
  ...
  return (
   <section id="about" className="w-screen h-screen flex flex-col justify-start items-center pt-16 relative overflow-hidden bg-purple-500">
     {/* TITLE */}
     <div className="mb-10 max-[1350px]:mb-8 max-[650px]:mb-6">
     ...
     <div className="bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950 text-white p-6 border-3 border-gray-600 pixel-shadow max-[1350px]:text-sm max-[650px]:text-xs max-[1350px]:p-4 max-[650px]:p-3 max-w-lg mx-4">
       <p className="glow-text text-[28px] leading-relaxed max-[1350px]:leading-normal max-[650px]:leading-tight max-[650px]:text-[23px] mb-2 max-[500px]:text-[21px] max-[500px]:mb-1">
