...
// Calculating the scroll progress. Measures the range of the animation by using endAt and startAt, then calculates how far the user has scrolled in that range. The range of numbers are from 0(start of animation) to 1(end of animation).
...
// Calaculating the current opacity based on the eased progress. 
